...
export const schema = { ...coreSchema, ...servicePlanSchema, ...diagnosticSchema, ...repairBrainSchema, ...financeSchema, ...authAccountsSchema, ...contentSchema, ...aiSchema, ...etechKeysSchema };

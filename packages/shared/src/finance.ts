...
export const DEFAULT_COST_CENTERS = [
  { name: "Field Operations", code: "FIELD-OPS", description: "General technical operations not assignable to a specific service line" },
  { name: "HVAC & Air Conditioning", code: "HVAC", description: "Split AC, central AC, industrial AC, ventilation, servicing, installations" },
  { name: "Refrigeration & Cold Rooms", code: "REFRIGERATION", description: "Refrigerators, freezers, commercial refrigeration, cold rooms" },
  { name: "Home Appliances", code: "APPLIANCES", description: "Washing machines, dryers, microwaves, cookers, water heaters" },
  { name: "Electrical & Power Systems", code: "ELECTRICAL", description: "Electrical work, wiring, panels, motors, power troubleshooting" },
  { name: "Solar & Inverters", code: "SOLAR", description: "Solar installation, inverter systems, batteries, backup power" },
  { name: "Generators", code: "GENERATORS", description: "Generator servicing, repair, related technical work" },
  { name: "Automotive Cooling", code: "AUTO-AC", description: "Vehicle AC, automotive cooling diagnostics, compressors, condensers" },
  { name: "Commercial & Industrial Services", code: "COMMERCIAL", description: "Multi-discipline commercial/industrial operations" },
  { name: "Administration", code: "ADMIN", description: "Office, management administration, general overhead" },
  { name: "Sales & Marketing", code: "MARKETING", description: "Advertising, content, banners, promotions, customer acquisition" },
  { name: "Training & People Development", code: "PEOPLE", description: "Staff training, technician development, internships" },
  { name: "Workshop & Facilities", code: "FACILITIES", description: "NNACT premises, workshop maintenance, utilities" },
  { name: "Management & Corporate", code: "CORPORATE", description: "Legitimate corporate-level costs not attributable to Admin or service lines" },
] as const;

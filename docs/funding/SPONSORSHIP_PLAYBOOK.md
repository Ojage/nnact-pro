...
OpenFieldPro is an AGPL-licensed, self-hostable alternative to subscription-first field-service platforms. Sponsorship should fund maintenance, security, documentation, testing, accessibility, and reliable releases without selling control over the project.

## 1. Apply for GitHub Sponsors

GitHub's current personal-account process requires joining GitHub Sponsors, completing a sponsor profile, creating optional tiers, submitting bank or fiscal-host and tax information, enabling two-factor authentication, and requesting approval.

1. Enable two-factor authentication on the `niko4244` GitHub account.
2. Review whether payouts should go directly to a bank account or through a fiscal host **before enrollment**. GitHub states that the fiscal-host choice is made during signup and changing later requires support.
...
7. Build the sponsor profile:
   ...
   - Concrete sponsor goal
8. Publish monthly and one-time tiers.
9. Choose **Request approval**.
10. After approval, verify the Sponsor profile publicly and merge `.github/FUNDING.yml` into the default branch.
...
GitHub currently supports up to ten monthly and ten one-time tiers. Start with a small, understandable set; tier prices cannot be edited after publication and must instead be retired and replaced.
...
| Sustaining Sponsor | $500/month | Prominent logo, compatibility-testing queue, quarterly group technical briefing |
| Founding Sponsor | $1,000/month | Founding recognition, limited scheduled support hours, quarterly executive/project briefing |
...
## 4. Build the sponsorship package
...
- Project metrics: contributors, releases, installations when measurable, issues closed, test coverage, and active deployments when users opt in
...
5. Self-hosting, managed Postgres, object-storage, and infrastructure companies
...
## 7. Grants and fiscal hosting

A fiscal host can receive and administer funds for a project, but it may charge fees and impose reporting or spending rules. Decide whether OpenFieldPro needs this before GitHub Sponsors enrollment. Compare:

- Eligibility and legal structure
- Fees
- Tax handling
- Expense reimbursement process
- Ownership of funds and assets
- Reporting requirements
- Ability to accept corporate grants
...
Publish a quarterly sponsor report containing:

- Funds received by category
- Processing/fiscal-host fees
- Infrastructure and contractor spending
- Releases and security work completed
- Work deferred
- Current runway for project expenses

Sponsor funding must not override security, code review, licensing, contributor credit, or user privacy. Material sponsor relationships should be disclosed.
